                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="Matricula" type="Matricula" class="form-control @error('Matricula') is-invalid @enderror" name="Matricula" value="{{ old('Matricula') }}" required autocomplete="Matricula">
